...
extern volatile struct Rtctime time1;
extern volatile uint8_t screen;
extern volatile uint8_t plug;
extern volatile uint8_t chkalarm;
extern uint8_t numicon;
extern uint8_t settime;

volatile uint8_t x = 5;
volatile uint8_t z = 10;
...
INTERRUPT_HANDLER(EXTI_PORTB_IRQHandler, 4)
{
  ...
  */
	...
	/*if (GPIO_ReadInputPin(PwsensePort, PwsensePin) == 1)
	{
		plug = 1;
		screen = ENABLE;
		x = 5;
	}
	if (GPIO_ReadInputPin(PwsensePort, PwsensePin) == 0)
	{
		plug = 0;
		screen = ENABLE;
		x = 5;
...
extern volatile uint8_t Push;

extern uint8_t sound;
extern uint8_t light;

extern volatile uint8_t Changing;
/**
...
volatile uint16_t y = 50;
extern uint8_t inversescreen;
...
/**
 ...
 extern volatile uint8_t alarmrhythm;
